...
@XmlRootElement(name = "returnAttentedNotUpdatedConsultationsResponse", namespace = "http://clinical/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "returnAttentedNotUpdatedConsultationsResponse", namespace = "http://clinical/")

...
@XmlRootElement(name = "updatePerscription", namespace = "http://clinical/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updatePerscription", namespace = "http://clinical/", propOrder = {
    "arg0",
    "arg1"
})
public class UpdatePerscription {

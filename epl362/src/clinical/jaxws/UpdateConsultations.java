...
@XmlRootElement(name = "updateConsultations", namespace = "http://clinical/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateConsultations", namespace = "http://clinical/", propOrder = {
    "arg0",
    "arg1"
})
public class UpdateConsultations {

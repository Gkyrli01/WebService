...
@XmlRootElement(name = "returnLastPerscriptionDetailsByPIdResponse", namespace = "http://clinical/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "returnLastPerscriptionDetailsByPIdResponse", namespace = "http://clinical/")

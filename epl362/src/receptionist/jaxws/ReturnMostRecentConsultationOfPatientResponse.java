...
@XmlRootElement(name = "returnMostRecentConsultationOfPatientResponse", namespace = "http://receptionist/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "returnMostRecentConsultationOfPatientResponse", namespace = "http://receptionist/")

...
@XmlRootElement(name = "returnNotAttentedPatientsResponse", namespace = "http://receptionist/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "returnNotAttentedPatientsResponse", namespace = "http://receptionist/")
